...
public class TemperatureFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {

    private BloodPressureApadter mAdapter;
    private List<BloodPressureBean> dataBean = new ArrayList<>();

    String[] titles = {"16:00", "17:00", "18:00", "19:00", "15:00", "14:00", "12:00", "11:00", "10:00", "9:00", "8:00"};
